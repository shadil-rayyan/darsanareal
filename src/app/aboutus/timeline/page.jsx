...
const Aboutusnavbar = () => {
  	...
  	return (
    		<div className="w-full relative bg-steelblue-200 h-[70px] text-center text-xs text-black font-raleway">
      			...
      			<div className="absolute h-full w-[calc(100%_-_977.2px)] top-[0px] right-[3.2px] bottom-[0px] left-[974px] bg-steelblue-300 cursor-pointer" onClick={onDivelementorWidgetWrapContainer6Click}>
