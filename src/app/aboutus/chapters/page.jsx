...
const Frame = () => {
  	...
  	return (
    		<div className="w-full relative h-[571px] text-left text-xs text-black font-raleway">
      			<div className="absolute top-[205px] left-[33px] w-[1151px] h-[366px]">
        				<div className="absolute top-[12px] right-[649px] tracking-[1px] leading-[27px] flex items-center w-[502px] h-[354px]">
          					<span className="w-full">
            						<p className="m-0">As its members were widely dispersed across the globe, Darsana recognized early on that true growth could only be achieved through a strong network of independent chapters in various parts of the globe. Darsana's strength lies in its chapters. The programs initiated and carried out by different chapters have produced commendable results. Through chapters, Darsana's dream of becoming an umbrella organization for over 3000 former NSSCE students from the early 1960s to the present is being realized.</p>
            						<p className="m-0">
              							<a className="text-[inherit]" href="https://darsana.in/aboutus#" target="_blank">
                								<span className="[text-decoration:underline]">&nbsp;</span>
              							</a>
            						</p>
          					</span>
        				</div>
        				<img className="absolute top-[0px] left-[586px] w-[565px] h-[281px] object-cover" alt="" src="image 17.png" />
      			</div>
      			<div className="absolute top-[0px] left-[calc(50%_-_592px)] bg-gray w-[1140px] h-[70px] text-center">
        				...
        				<div className="absolute h-full w-[calc(100%_-_977.2px)] top-[0px] right-[814.36px] bottom-[0px] left-[162.84px] bg-steelblue-200 cursor-pointer" onClick={onDivelementorWidgetWrapContainer1Click}>
        				...
        				<div className="absolute h-full w-[calc(100%_-_977.2px)] top-[0px] right-[325.82px] bottom-[0px] left-[651.38px] bg-steelblue-300 cursor-pointer" onClick={onDivelementorWidgetWrapContainer4Click}>
